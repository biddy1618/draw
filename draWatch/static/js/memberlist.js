...
(function(d, s, id){
	...
	js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=272167629913460";
	fjs.parentNode.insertBefore(js, fjs);
 }(document, 'script', 'facebook-jssdk'));

$("#invitebutton").click(function(){
	var vars = window.location.href.split("\/");
	var url = /*vars[2]*/ /*"letsyoutube.herokuapp.com"*/ "192.249.29.50:5000" + "/r_"+ videoID+ "_n_"+ roomID;
